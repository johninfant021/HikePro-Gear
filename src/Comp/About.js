        ...
        <section className="min-h-screen text-white px-4 md:px-16 py-20">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ...
              adventurers with high-quality gear that empowers them to conquer
              any trail, mountain, or journey. Whether you’re a weekend hiker or
              a seasoned trekker, we’ve got your back — literally.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-300">
                Every product we offer is field-tested, eco-friendly, and built
