...
const LandingPage = () => {
  ...
  return (
    <div>
      <div
        className="md:h-[100vh] rounded-lg  h-[50vh] bg-cover bg-center bg-opacity-50"
        style={{
      ...
      >
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="flex flex-col gap-4 p-5 bg-gray-600 text-white md:hidden">
        ...
        <section className="md:relative md:h-[90vh] md:flex flex-col items-center justify-center">
          {/* Social Icons Left */}
          <div data-aos="fade-right" className="md:absolute md:top-1/2 md:left-6 md:-translate-y-1/2 text-white text-xs flex md:flex-col justify-center gap-5 m-5 items-center md:space-y-3">
          ...
          <div data-aos="fade-left" className="absolute right-6 top-1/2 hidden md:flex md:flex-col -translate-y-1/2 flex flex-col items-center text-white text-xs space-y-2">
      ...
      <div className="bg-[#0B1D26]">
        ...
        >
          <div>
            <h2 className="text-6xl text-gray-600 font-bold">01</h2>
            <p className="text-sm text-yellow-400 uppercase mb-2">
              Get Started
            </p>
        ...
        >
          ...
          />
          <div>
            <h2 className="text-6xl text-gray-600 font-bold">02</h2>
            <p className="text-sm text-yellow-400 uppercase mb-2">
              Hiking Essentials
            </p>
            <h3 className="text-2xl font-bold mb-4 text-white">
        ...
        >
          <div>
            <h2 className="text-6xl text-gray-600 font-bold">03</h2>
            <p className="text-sm text-yellow-400 uppercase mb-2">
